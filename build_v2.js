...
// 14 waypoint locations with proper spacing
const WP = [
  {nx:0.18,ny:0.30,title:'VOYAGE MMXXVI',tag:'THE TALE',sub:'A 36-Hour Plunder of Innovation',
    secs:[{h:'SAIL BEYOND THE KNOWN WORLD',b:'Plunder the Depths of Innovation. Hoist the sails and chart a course through uncharted waters. Voyage beckons the boldest crews to forge legends across a relentless 36-hour tide where ideas become treasure and innovators become captains of tomorrow.'},{h:'THE NUMBERS',b:'36 Hours - The Tide | 3-4 Crew Size | Rs.25,000 Treasure | 26 and 27 September MMXXVI'}],
    footer:'HOIST THE SAILS - Register now and claim yer place among the legends.',hue:32},
  {nx:0.55,ny:0.18,title:'THE WATERS I-III',tag:'THE WATERS',sub:'Choose Thy Domain',
    secs:[{h:'I - AI Machine Learning - Devils Triangle',b:'Harness the dark arts of AI and Machine Learning to conquer the unknown. Forge cognitive systems, predictive charting, and intelligent automation that bend the rules of the known world. Tags: LLMs, RAG, Agents, Neural Nets'},{h:'II - Blockchain Web3 - Tortuga Market',b:'Navigate the future through Blockchain and decentralized waters. Build immutable contracts, token economies, and dApps that answer to no king. Tags: Smart Contracts, DeFi, dApps, Web3'},{h:'III - FinTech - Dead Mens Ledger',b:'Redefine the world of gold and ledgers through secure, scalable financial instruments. Where every transaction tells a tale of trust. Tags: Payments, Banking, Fraud, Trading'}],
    footer:'Six treasure-hunt domains forged to test the boldest crews.',hue:28},
  {nx:0.82,ny:0.22,title:'THE WATERS IV-VI',tag:'THE WATERS',sub:'Domains IV, V and VI',
    secs:[{h:'IV - Healthcare - Fountain of Youth',b:'Leverage the healing arts to build smarter, more accessible Healthcare. Tackle diagnostics, patient experience, and medical lore making care more human. Tags: MedTech, Diagnostics, Telehealth, AI Health'},{h:'V - Cybersecurity - Davy Jones Vault',b:'Fortify the digital realm against the ever-shifting tides of cyber threat. Build armored systems that guard treasure from raiders. Tags: AppSec, Crypto, Network, Forensics'},{h:'VI - Open Innovation - Shipwreck Cove',b:'Explore limitless waters and bring bold ideas to life across any domain. The cove rewards the daring, the creative, and the relentless. Tags: Any Domain, Creative, Bold Ideas'}],
    footer:'Pick the waters that match yer expertise and set sail toward glory.',hue:24},
  {nx:0.22,ny:0.55,title:'THE TREASURE COVE',tag:'TREASURE',sub:'Bounties and Booty',
    secs:[{h:'FIRST BOUNTY - Rs.10,000 - GOLD HOARD',b:'The finest crew claims the greatest hoard. Build something that shakes the seas and the gold is yours.'},{h:'SECOND BOUNTY - Rs.7,000 - SILVER CACHE',b:'Second only in gold but first in glory among the bold.'},{h:'THIRD BOUNTY - Rs.5,000 - BRONZE COFFER',b:'Every legend starts with a first conquest. The bronze coffer marks the beginning of your saga.'},{h:'EVERY SOUL CLAIMS A SHARE',b:'Crew Garb and T-Shirts, Voyager Certificates, Captains Bounty, Crew Insignia Stickers, The Brotherhood Network, Counsel of Mentors, Audience with Veterans'}],
    footer:'Total Treasure Pool: Rs.25,000 awaits the finest crews.',hue:38},
  {nx:0.70,ny:0.48,title:'CAPTAINS LOG',tag:'CAPTAINS LOG',sub:'The 36-Hour Odyssey',
    secs:[{h:'DAY THE FIRST',b:'Orientation of the Fleet, The Voyage Begins, Morning Watch Session I, The Midday Feast, Evening Rations, Deck Games Round I, The Night Feast, Counsel of Captains Session II, Deck Games Round II'},{h:'DAY THE SECOND',b:'Counsel of Captains Session III, The Judgement and Submission Window, Dawn Meal, The Midday Feast, Closing Ceremony, The Voyage Concludes'},{h:'KEY DATES',b:'The Voyage Sets Sail: 26 September 2026. The Voyage Concludes: 27 September 2026.'}],
    footer:'From orientation to closing ceremony - 36 relentless hours of tide.',hue:30},
  {nx:0.12,ny:0.70,title:'THE CAPTAINS CODE',tag:'CODEX',sub:'Rules of the Voyage',
    secs:[{h:'RULE I - Bring Your Arsenal',b:'Each voyager must bring their own laptop, charger, and power backup for the journey ahead.'},{h:'RULE II - No Desertion',b:'None shall depart the arena after registration until the voyage concludes and the tides recede.'},{h:'RULE III - Wear Yer Mark',b:'Wear yer participant insignia at all times within the hackathon arena. It is yer mark of passage.'},{h:'RULE IV - Sail Fair',b:'Wield only permitted resources and APIs in accordance with the captains code of conduct.'}],
    footer:'The code is law. Sail true or not at all.',hue:34},
  {nx:0.48,ny:0.72,title:'THE BROTHERHOOD',tag:'ALLIES',sub:'The GRID Fleet',
    secs:[{h:'WHO WE ARE',b:'A student-led fellowship of more than 2,000 souls dedicated to empowering students through collaboration, hands-on learning, and real-world opportunities.'},{h:'OUR FLEET',b:'2,000+ Souls of the Fleet, 800+ Voyagers Enlisted, AI and Web3 and Cyber Captains Sessions, Pan-India Reach of the Tides'},{h:'OUR MISSION',b:'Bridge the gap between academy and industry through hackathons, workshops, bootcamps, webinars, networking voyages, and technical initiatives that inspire innovation and forge practical skills.'}],
    footer:'STUDENT-LED, 2000+ SOULS, PAN-INDIA',hue:26},
  {nx:0.80,ny:0.68,title:'THE ALLIES',tag:'ALLIES',sub:'Backed by the Finest',
    secs:[{h:'BLOCKCHAIN ALLY - Algorand',b:'A high-performance Layer-1 blockchain forged for speed, security, and scalability. Near-instant finality, Pure Proof-of-Stake consensus, and energy-efficient architecture for the next generation of Web3.'},{h:'COMMUNITY ALLY - OSEN',b:'A technology-driven fellowship championing hackathons, workshops, and developer crews with sponsorships, mentorship, speakers, swag, and growth opportunities across colleges.'},{h:'AI AND TECH ALLY - Mewayz Global Corporation',b:'AI-powered Business Operating Platform for ventures, creators, and enterprises. AI orchestration, Web3, CRM, website builders, payment management and marketing tools all on one unified deck.'}],
    footer:'Industry titans powering Voyage with technology, counsel, and resources.',hue:22},
  {nx:0.35,ny:0.82,title:'THE CODEX',tag:'CODEX',sub:'Lore and Answers',
    secs:[{h:'WHO MAY JOIN?',b:'All undergraduate and postgraduate souls (1st Year to Final Year) from any college across the realm. No prior hackathon experience required, only the will to build.'},{h:'CREW AND TOLL',b:'Sail with a crew of 3 to 4 souls. There is no toll to enlist. The Voyage is free to join.'},{h:'HOW ARE VENTURES JUDGED?',b:'Innovation, Technical Execution, Real-World Impact, Presentation Quality, Domain Relevance. Expert captains shall oversee the judgement.'},{h:'WHAT TO BRING?',b:'Yer laptop, charger, and power backup. The arena provides the rest. You bring the fire.'}],
    footer:'More questions? Send a raven to the organizing crew.',hue:36},
  {nx:0.62,ny:0.30,title:'PARLEY',tag:'PARLEY',sub:'Send a Raven',
    secs:[{h:'THE ORGANIZING CREW',b:'Ganpati Raj: +91 9507542854 | Krishna Raj Barnwal: +91 7320000215 | Ritusree Chanda: +91 7362994375 | Aditya Gaurav: +91 70291 62093'},{h:'MORE CREW',b:'Neeraj Sahu: +91 9336345475 | Moumita Mandal: +91 9229726302 | Omkar Kumar: +91 9631922222 | Mayank Raj: +91 8969212216'},{h:'SEND A RAVEN',b:'Have questions about the Voyage? Reach out to our organizing crew. We stand ready to help ye set sail. Contact: gridcommunity@example.com'}],
    footer:'We stand ready. Send word and we shall answer.',hue:29},
  {nx:0.40,ny:0.40,title:'HIDDEN COVE',tag:'SECRET',sub:'Ye Found A Secret Location',
    secs:[{h:'THE TREASURE OF KNOWLEDGE',b:'True treasure lies not in gold but in the knowledge ye gain, the bonds ye forge, and the ideas ye bring to life.'},{h:'SAILORS WISDOM',b:'The roughest seas make the finest sailors. Every challenge faced during this voyage shapes the captain ye shall become.'}],
    footer:'Keep exploring - more secrets await in these waters.',hue:35},
  {nx:0.88,ny:0.50,title:'THE EASTERN ISLES',tag:'DISCOVERY',sub:'Remote Trading Post',
    secs:[{h:'MERCHANT TALES',b:'Here traders from distant lands exchange innovations, tools, and wisdom. Network with fellow voyagers and discover new possibilities.'},{h:'SUPPLIES AND PROVISIONS',b:'Restock yer mental energy with mentorship sessions, technical workshops, and collaborative spaces.'}],
    footer:'Every port offers new opportunities for those bold enough to explore.',hue:27},
  {nx:0.15,ny:0.85,title:'SOUTHERN DEPTHS',tag:'MYSTERY',sub:'The Kraken Territory',
    secs:[{h:'LEGENDARY CHALLENGES',b:'The deepest waters hide the greatest challenges. Tackle advanced problem statements that test the limits of innovation.'},{h:'RISK AND REWARD',b:'Ventures into unknown territory often yield the greatest discoveries. Fortune favors the bold.'}],
...
function wpToJS(wp){
  const secs=wp.secs.map(s=>`{h:${JSON.stringify(s.h)},b:${JSON.stringify(s.b)}}`).join(',');
...
const voyageJS=`(function(){'use strict';
function die(m){var e=document.getElementById('err');e.style.display='block';e.textContent='ERROR: '+m;console.error(m);}
...
var bookR=new THREE.WebGLRenderer({antialias:true,alpha:true});bookR.setPixelRatio(Math.min(devicePixelRatio,2));bookR.setSize(W,H);bookR.domElement.id='book-canvas';document.body.appendChild(bookR.domElement);
var mapR=new THREE.WebGLRenderer({antialias:true,alpha:true});mapR.setPixelRatio(Math.min(devicePixelRatio,2));mapR.setSize(W,H);mapR.domElement.id='map-canvas';document.body.appendChild(mapR.domElement);
var boatR=new THREE.WebGLRenderer({antialias:true,alpha:true});boatR.setPixelRatio(Math.min(devicePixelRatio,2));boatR.setSize(W,H);boatR.domElement.id='boat-canvas';document.body.appendChild(boatR.domElement);
var miniR=new THREE.WebGLRenderer({antialias:true,alpha:true,canvas:document.getElementById('mini-canvas')});miniR.setPixelRatio(1);miniR.setSize(180,130);
var cuR=new THREE.WebGLRenderer({antialias:true,alpha:true,canvas:document.getElementById('closeup-canvas')});cuR.setPixelRatio(1);cuR.setSize(300,412);
var bookCam=new THREE.PerspectiveCamera(45,W/H,0.01,500);bookCam.position.set(0,0.8,5.5);bookCam.lookAt(0,0.3,0);
var mapCam=new THREE.PerspectiveCamera(45,W/H,0.01,500);mapCam.position.set(0,2.5,7);mapCam.lookAt(0,-0.3,0);
var boatCam=new THREE.PerspectiveCamera(45,W/H,0.01,500);boatCam.position.set(0,2.8,6);boatCam.lookAt(0,0.2,0);
var miniCam=new THREE.PerspectiveCamera(50,180/130,0.01,500);miniCam.position.set(0,7,9);miniCam.lookAt(0,0,0);
var cuCam=new THREE.PerspectiveCamera(35,300/412,0.01,500);cuCam.position.set(0,0.5,3.5);cuCam.lookAt(0,0.3,0);
function mkDL(c,i,x,y,z){var l=new THREE.DirectionalLight(c,i);l.position.set(x,y,z);return l;}
var bookS=new THREE.Scene();bookS.add(new THREE.AmbientLight(0xffffff,0.9));bookS.add(mkDL(0xffd090,0.8,3,5,4));
var mapS=new THREE.Scene();mapS.add(new THREE.AmbientLight(0xffffff,0.85));mapS.add(mkDL(0xffffff,0.9,5,10,7));mapS.add(mkDL(0xffd090,0.4,-5,5,-5));
var boatS=new THREE.Scene();boatS.add(new THREE.AmbientLight(0xffffff,1.0));boatS.add(mkDL(0xffd090,1.1,3,8,5));boatS.add(mkDL(0xffffff,0.5,-3,4,-2));
var cuS=new THREE.Scene();cuS.add(new THREE.AmbientLight(0xffffff,1.0));cuS.add(mkDL(0xffd090,0.8,2,4,3));
...
function animate(){requestAnimationFrame(animate);var t=clock.getElapsedTime();if(bookRoot&&(appState==='book'||appState==='transitioning')){bookRoot.rotation.y=Math.sin(t*0.4)*0.35;bookRoot.position.y=Math.sin(t*0.7)*0.08;bookR.render(bookS,bookCam);}if(appState==='map'||appState==='transitioning'||appState==='popup'){if(mapRoot)mapRoot.position.y=Math.sin(t*0.3)*0.04;mapR.render(mapS,mapCam);if(boatRoot){boatRoot.rotation.y=t*0.85;boatRoot.position.y=0.22+Math.sin(t*1.1)*0.05;}boatR.render(boatS,boatCam);miniR.render(mapS,miniCam);}}
document.addEventListener('click',function(e){if(appState==='book'){var targ=e.target;if(targ.id==='book-canvas'||targ.tagName==='CANVAS'||targ.classList.contains('bg-parchment')||targ.tagName==='BODY'){goToMap();}}});
window.addEventListener('resize',function(){W=window.innerWidth;H=window.innerHeight;[bookCam,mapCam,boatCam].forEach(function(c){c.aspect=W/H;c.updateProjectionMatrix();});bookR.setSize(W,H);mapR.setSize(W,H);boatR.setSize(W,H);});
setProgress(0.05);var loaded=0,total=3;var fakeP=0.05;var fakeInt=setInterval(function(){if(fakeP<0.88){fakeP+=0.007;setProgress(fakeP);}},100);
function onLoad(){loaded++;setProgress(0.05+(loaded/total)*0.95);if(loaded>=total){clearInterval(fakeInt);setProgress(1);setTimeout(function(){var ldg=document.getElementById('loading');ldg.classList.add('out');setTimeout(function(){ldg.style.display='none';},1100);appState='book';animate();},400);}}
loader.load('book_of_pirate_rules_-_week_5.glb',function(g){var inner=g.scene;fitTo(inner,2.5);bookRoot=new THREE.Group();bookRoot.add(inner);bookS.add(bookRoot);cuRoot=bookRoot;cuRoot._bs=inner.scale.x;onLoad();},null,function(e){console.error('Book:',e);onLoad();});
loader.load('pirate_map.glb',function(g){var inner=g.scene;fitTo(inner,3);baseMapScale=inner.scale.x;mapRoot=new THREE.Group();mapRoot.add(inner);mapRoot.position.set(0,-0.5,0);mapRoot.rotation.x=-Math.PI/12;mapRoot.scale.setScalar(0.001);mapS.add(mapRoot);onLoad();},null,function(e){console.error('Map:',e);onLoad();});
loader.load('ship_pinnace_aft_diff.glb',function(g){var inner=g.scene;fitTo(inner,0.95);boatRoot=new THREE.Group();boatRoot.add(inner);boatRoot.position.set(0,0.22,0);boatS.add(boatRoot);onLoad();},null,function(e){console.error('Ship:',e);onLoad();});
})();`;
...
.bg-wood{position:fixed;inset:0;z-index:0;pointer-events:none;background:repeating-linear-gradient(90deg,#3d2308 0,#4e2e0a 2px,#61390f 4px,#724418 6px,#61390f 8px,#4e2e0a 12px,#3d2308 38px,#5a3510 40px),linear-gradient(180deg,#2a1505,#3a1f08 30%,#2e1806 70%,#1e1004);background-size:40px 100%,100% 100%}
.bg-parchment{position:fixed;top:1.5%;left:2%;right:2%;bottom:1.5%;z-index:1;pointer-events:none;background:repeating-linear-gradient(128deg,transparent 0,transparent 60px,rgba(120,80,20,.06) 60px,rgba(120,80,20,.06) 61px),radial-gradient(ellipse at 30% 25%,#e2c98a 0,transparent 50%),radial-gradient(ellipse at 70% 75%,#d4b46a 0,transparent 45%),radial-gradient(ellipse at 50% 50%,#dbbf7e 0,#c6a050 50%,#9a7230 80%,#7a5520 100%);clip-path:polygon(1% 4%,0% 0%,4% 1%,8% 0%,12% 3%,16% 0%,21% 2%,26% 0%,31% 3%,36% 0%,41% 2%,46% 0%,51% 3%,56% 0%,61% 2%,66% 0%,71% 3%,76% 0%,81% 2%,86% 0%,91% 3%,95% 0%,99% 2%,100% 0%,100% 4%,99% 10%,100% 17%,99% 24%,100% 31%,99% 38%,100% 45%,99% 52%,100% 59%,99% 66%,100% 73%,99% 80%,100% 87%,99% 94%,100% 100%,96% 98%,91% 100%,86% 98%,81% 100%,76% 98%,71% 100%,66% 98%,61% 100%,56% 98%,51% 100%,46% 98%,41% 100%,36% 98%,31% 100%,26% 98%,21% 100%,16% 98%,11% 100%,6% 98%,2% 100%,0% 99%,1% 93%,0% 86%,1% 79%,0% 72%,1% 65%,0% 58%,1% 51%,0% 44%,1% 37%,0% 30%,1% 23%,0% 16%,1% 9%,0% 4%)}
.bg-vignette{position:fixed;inset:0;z-index:2;pointer-events:none;box-shadow:inset 0 0 90px 45px rgba(8,3,0,.95),inset 0 0 220px 60px rgba(5,2,0,.5)}
...
#loc-box{width:90vw;max-width:1100px;height:85vh;overflow-y:auto;padding:52px 64px 48px;pointer-events:auto;cursor:auto;clip-path:polygon(0% 1.5%,1% 0%,3% 1%,6% 0%,9% 1.5%,13% 0%,17% 1%,21% 0%,25% 1.5%,29% 0%,33% 1%,37% 0%,41% 1.5%,45% 0%,49% 1%,53% 0%,57% 1.5%,61% 0%,65% 1%,69% 0%,73% 1.5%,77% 0%,81% 1%,85% 0%,89% 1.5%,93% 0%,96% 1%,99% 0%,100% 1.5%,99% 4%,100% 9%,99% 14%,100% 20%,99% 26%,100% 32%,99% 38%,100% 44%,99% 50%,100% 56%,99% 62%,100% 68%,99% 74%,100% 80%,99% 86%,100% 92%,99% 97%,100% 100%,97% 99%,93% 100%,89% 99%,85% 100%,81% 99%,77% 100%,73% 99%,69% 100%,65% 99%,61% 100%,57% 99%,53% 100%,49% 99%,45% 100%,41% 99%,37% 100%,33% 99%,29% 100%,25% 99%,21% 100%,17% 99%,13% 100%,9% 99%,5% 100%,2% 99%,0% 100%,1% 96%,0% 91%,1% 85%,0% 79%,1% 73%,0% 67%,1% 61%,0% 55%,1% 49%,0% 43%,1% 37%,0% 31%,1% 25%,0% 19%,1% 13%,0% 7%,1% 3%);background:radial-gradient(ellipse at 28% 18%,#e2c98a,#c9a85a 35%,#8a6028 100%);transform:scale(0.03);transition:transform .9s cubic-bezier(.175,.885,.32,1.275);box-shadow:0 30px 100px rgba(0,0,0,.98)}
...
console.log('Complete! voyage.js='+voyageJS.length+' index.html='+indexHTML.length);
